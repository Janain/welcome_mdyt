...
import com.wangjj.app.BuildConfig
...
object RetrofitHelper {
        ...
        val okHttpClientBuilder = OkHttpClient().newBuilder().apply {
            ...
            addInterceptor {
                ...
                if (domain.isNotEmpty()) {
                    val spDomain: String by BasePreference(domain, "")
    ...
    private fun saveCookie(url: String?, domain: String?, cookies: String) {
        url ?: return
        var spUrl: String by BasePreference(url, cookies)
        @Suppress("UNUSED_VALUE")
        spUrl = cookies
        domain ?: return
        var spDomain: String by BasePreference(domain, cookies)
        @Suppress("UNUSED_VALUE")
        spDomain = cookies
    }
